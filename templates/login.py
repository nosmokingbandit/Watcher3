...
class Login(object):
    ...
    def default(self, username=None, from_page=''):
        ...
        with doc.head:
            ...
            link(rel='stylesheet', href=core.URL_BASE + '/auth/static/css/style.css?v=05.03')
            link(rel='stylesheet', href=core.URL_BASE + '/auth/static/css/{}style.css?v=05.03'.format(core.CONFIG['Server']['theme']))
            link(rel='stylesheet', href=core.URL_BASE + '/auth/static/css/login.css?v=05.03')
            link(rel='stylesheet', href=core.URL_BASE + '/auth/static/css/{}login.css?v=05.03'.format(core.CONFIG['Server']['theme']))
            ...
            script(type='text/javascript', src=core.URL_BASE + '/auth/static/js/login/main.js?v=03.28')
