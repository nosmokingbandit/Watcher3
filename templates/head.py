...
class Head(object):
    ...
    def insert():
        ...
        link(rel='stylesheet', href=core.URL_BASE + '/static/css/style.css?v=03.15')
        link(rel='stylesheet', href=core.URL_BASE + '/static/css/{}style.css?v=03.15'.format(core.CONFIG['Server']['theme']))
