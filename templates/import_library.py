...
class ImportLibrary():
    ...
    def default(self):
        ...
        with doc.head:
            Head.insert()
            link(rel='stylesheet', href=core.URL_BASE + '/static/css/import_library.css?v=04.03')
            link(rel='stylesheet', href=core.URL_BASE + '/static/css/{}import_library.css?v=04.03'.format(core.CONFIG['Server']['theme']))
            script(type='text/javascript', src=core.URL_BASE + '/static/js/import_library/main.js?v=04.03')
                ...
                with div(id='import_sources'):
                    ...
                    with div():
                        with a(href=core.URL_BASE + '/import_library/plex'):
                            img(src=core.URL_BASE + '/static/images/plex.png', alt='Kodi', cls='import_source_icon')
                            br()
                            span('Plex')
                    with div():
