...
class ImportLibrary():
    ...
    def default(self):
        ...
        with doc.head:
            Head.insert()
            link(rel='stylesheet', href=core.URL_BASE + '/static/css/import_library.css?v=05.03')
            link(rel='stylesheet', href=core.URL_BASE + '/static/css/{}import_library.css?v=05.03'.format(core.CONFIG['Server']['theme']))
